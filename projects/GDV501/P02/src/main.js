...
const cfg = {"n":"02","title":"Hazard Dividend","slug":"hazard-dividend","repo":"GDV501-P02-hazard-dividend","kind":"risk","deck":"Every prize improves the score and worsens the board.","generic":"Model risk, reward, and opportunity cost; communicate danger without text dependency; balance short-term gain against long-term survival.","specific":"Collect valuable cores in a field of patrol hazards. Each core increases score, hazard speed, and map pressure. Exit early for a banking bonus or keep collecting for a riskier multiplier.","controls":"Arrow keys or WASD to move, Space to bank at the gate","palette":["#eef8fb","#142234","#246b9f","#d99a18","#c6414b"],"id":"GDV501-P02"};
