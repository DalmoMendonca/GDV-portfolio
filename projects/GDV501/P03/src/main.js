...
const cfg = {"n":"03","title":"Alchemist's Ledger","slug":"alchemists-ledger","repo":"GDV501-P03-alchemists-ledger","kind":"resource","deck":"Five puzzles about turning nouns into verbs.","generic":"Design resources as verbs; create puzzle constraints from conversion rules; teach through level sequence.","specific":"Use three resource types and two conversion actions across five authored levels. The sequence introduces conversion, scarcity, and goal checking without a tutorial paragraph.","controls":"Click conversion actions, R to reset level","palette":["#17130f","#f7efe2","#c88442","#65b891","#6279b8"],"id":"GDV501-P03"};
