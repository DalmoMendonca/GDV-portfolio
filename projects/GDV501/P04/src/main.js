...
const cfg = {"n":"04","title":"The Quiet Bid","slug":"the-quiet-bid","repo":"GDV501-P04-the-quiet-bid","kind":"bluff","deck":"A tiny duel of tells, pressure, and private information.","generic":"Use uncertainty as a system; create readable tells and counterplay; design AI or local multiplayer decision moments.","specific":"Play five rounds against a readable bot. Probe, feint, or commit based on partial tells. Match recap reveals the hidden values and explains the counterplay.","controls":"Click Probe, Feint, or Commit","palette":["#f7f1e7","#211720","#7d4f9e","#b87818","#2f8b68"],"id":"GDV501-P04"};
