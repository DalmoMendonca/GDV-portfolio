...
const cfg = {"n":"05","title":"Kinetic Serif","slug":"kinetic-serif","repo":"GDV501-P05-kinetic-serif","kind":"movement","deck":"A five-room movement study built around a charged dash.","generic":"Make movement itself the primary mechanic; shape challenge through spatial affordances; tune acceleration, friction, jump, dash, glide, or equivalent properties.","specific":"Cross five compact rooms using one expressive movement verb: hold to charge, release to dash. Hazards, gates, and landing lanes teach control without combat or inventory.","controls":"Arrow keys or WASD to steer, hold/release Space to dash","palette":["#f4f7fb","#172235","#1782a6","#d85b93","#508c4f"],"id":"GDV501-P05"};
