...
const cfg = {"n":"06","title":"Civic Fault Lines","slug":"civic-fault-lines","repo":"GDV501-P06-civic-fault-lines","kind":"choice","deck":"Choices alter the rules, not just the ending text.","generic":"Represent consequence in mechanics; distinguish cosmetic choice from systemic choice; build replayable branches.","specific":"Make three civic decisions. Each changes later costs, available actions, trust, and ending conditions. The final state is a mechanical consequence report, not a simple moral label.","controls":"Click one policy at each decision point","palette":["#f1f6ee","#17241f","#2f8b67","#c66a2e","#b53d4b"],"id":"GDV501-P06"};
