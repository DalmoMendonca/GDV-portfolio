...
const cfg = {"n":"07","title":"Twin Lock Study","slug":"twin-lock-study","repo":"GDV501-P07-twin-lock-study","kind":"coop","deck":"Two bodies, asymmetric limits, one shared exit.","generic":"Design cooperation through asymmetric limits; create communication pressure; evaluate whether cooperation is required or optional.","specific":"Control two linked roles in four encounters. The heavy role anchors switches and blocks beams; the light role crosses gaps and collects keys. Either role alone is insufficient.","controls":"Tab switches roles, arrows/WASD move, Space uses role power","palette":["#edf3fb","#17233a","#2d67b2","#b98620","#bf4561"],"id":"GDV501-P07"};
