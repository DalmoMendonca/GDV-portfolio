...
const cfg = {"n":"08","title":"Director's Cut","slug":"directors-cut","repo":"GDV501-P08-directors-cut","kind":"adaptive","deck":"An arcade director watches pressure and changes the score.","generic":"Adapt challenge to player performance; measure player state without being intrusive; preserve dignity and agency when assistance is provided.","specific":"Dodge pressure waves while collecting signal marks. The director tracks hits, near misses, and collection rate, then changes spawn density, reward value, and recovery support with a transparent report.","controls":"Arrow keys or WASD to move","palette":["#f1f4f7","#18222c","#217a9f","#d79620","#c23e5a"],"id":"GDV501-P08"};
