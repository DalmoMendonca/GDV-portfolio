...
const cfg = {"n":"09","title":"Magnet Toybox","slug":"magnet-toybox","repo":"GDV501-P09-magnet-toybox","kind":"toy","deck":"A field toy becomes a scored collection game without losing play.","generic":"Differentiate toy, puzzle, and game; discover affordances through experimentation; add goals without killing expressive play.","specific":"Pull and push drifting particles with a magnetic cursor, then use the same expressive system to herd luminous motes into scoring rings before time expires.","controls":"Move mouse or drag, hold Space/click to attract, Shift to repel","palette":["#fff6e8","#1f2a2d","#1a8a96","#d49b20","#d75d42"],"id":"GDV501-P09"};
