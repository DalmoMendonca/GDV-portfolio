...
const cfg = {"n":"10","title":"Festival Signal","slug":"festival-signal","repo":"GDV501-P10-festival-signal","kind":"festival","deck":"A public-play station with instant onboarding and fast turnover.","generic":"Scope a complete experience for public play; create immediate onboarding; design for spectators and fast turnover.","specific":"Rotate signal mirrors to route light through three gates before the festival clock expires. The board is readable from a distance and can be completed or restarted in under ten minutes.","controls":"Click mirrors to rotate, R to restart","palette":["#12140f","#f4f0df","#d9ed92","#76c893","#f28482"],"id":"GDV501-P10"};
