...
Public repository target: GDV502-P01-state-machine-arcade-game

Netlify status: Placeholder. Deploy this game when implementation begins.

## Generic Description

Implement explicit game states; separate input, update, and rendering concerns; handle transitions reliably.
...
- Local project path: projects/GDV502/P01
- Public game URL: TBD
